...
export const prefectures: Prefecture[] = [
  // Hokkaido
  {
    ...
    similarTo: 'Scandinavia — vast snowy landscapes, seafood, and outdoor adventures',
  },
  // Tohoku
  {
    ...
    similarTo: 'Vermont, USA — apple orchards, autumn colors, and rural charm',
  },
  {
    ...
    similarTo: 'Scottish Highlands — rugged coastlines and deep cultural heritage',
  },
  {
    ...
    similarTo: 'Portland, Maine — coastal city with great local food',
  },
  {
    ...
    similarTo: 'Finnish Lakeland — lakes, hot springs, and peaceful countryside',
  },
  {
    ...
    similarTo: 'Swiss Alpine villages — picturesque hot spring towns in the mountains',
  },
  {
    ...
    similarTo: 'Tuscany, Italy — rolling hills, great fruit, and hidden gems',
  },
  // Kanto
  {
    ...
    similarTo: 'Cotswolds, England — underrated countryside with historic shrines',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Yosemite area, USA — waterfalls, forests, and iconic landmarks',
  },
  {
    ...
    similarTo: 'Iceland — famous hot springs and crystal-clear waters',
  },
  {
    ...
    similarTo: 'Brooklyn, NYC — always in Tokyo\'s shadow but full of surprises',
  },
  {
    ...
    similarTo: 'Anaheim, USA — home to Disneyland and close to the big city',
  },
  {
    ...
    similarTo: 'New York City — the city that never sleeps, infinite variety',
  },
  {
    ...
    similarTo: 'Nice & Monaco — port city glamour meets historic coastal towns',
  },
  // Chubu
  {
    ...
    image: 'https://images.unsplash.com/photo-1542640244-7e672d6cef4e?w=800',
    similarTo: 'Champagne, France — Japan\'s finest rice and sake region',
  },
  {
    ...
    similarTo: 'Austrian Alps — dramatic alpine scenery and traditional villages',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1553653924-39b70295f8da?w=800',
    similarTo: 'Florence, Italy — compact, walkable, full of art and history',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Nova Scotia, Canada — coastal scenery and famous local crab',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?w=800',
    similarTo: 'Napa Valley, USA — Mt. Fuji views, wineries, and mountain trails',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1542640244-7e672d6cef4e?w=800',
    similarTo: 'Colorado, USA — skiing, mountain retreats, and outdoor paradise',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1578637387939-43c525550085?w=800',
    similarTo: 'Hallstatt, Austria — fairytale villages that foreign visitors love most',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?w=800',
    similarTo: 'Amalfi Coast, Italy — beaches, hot springs, and stunning views',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1480796927426-f609979314bd?w=800',
    similarTo: 'Dallas, USA — big city hub but not a tourist destination',
  },
  // Kansai
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Canterbury, England — famous shrine but skip unless it\'s your goal',
  },
  {
    ...
    similarTo: 'Lake Como, Italy — beautiful lake near a major cultural city',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800',
    similarTo: 'Prague — ancient temples, tradition, and crowds of tourists',
  },
  {
    ...
    similarTo: 'Chicago, USA — great food and energy, but similar to Tokyo',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=800',
    similarTo: 'Lisbon, Portugal — port city, castle, and nearby island paradise',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Bruges, Belgium — charming day trip, but small',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Algarve, Portugal — beautiful coast but hard to reach',
  },
  // Chugoku
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Sahara meets rural France — unique sand dunes in the countryside',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Rural Ireland — barely any shops, deeply spiritual atmosphere',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Bruges, Belgium — preserved historic district, worth a second trip',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=800',
    similarTo: 'Berlin, Germany — history, culture, and great local food scene',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Porto, Portugal — nostalgic port towns and quiet beauty',
  },
  // Shikoku
  {
    ...
    similarTo: 'Camino de Santiago — pilgrimage trails and traditional dance',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1601823984263-b87b59798b70?w=800',
    similarTo: 'Bologna, Italy — small but the best noodles you\'ll ever eat',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1601823984263-b87b59798b70?w=800',
    similarTo: 'Valencia, Spain — citrus paradise on a sunny island',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1601823984263-b87b59798b70?w=800',
    similarTo: 'Patagonia — stunning nature but very remote',
  },
  // Kyushu & Okinawa
  {
    ...
    image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=800',
    similarTo: 'Barcelona, Spain — great food, nightlife, and gateway to the region',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Rural Belgium — pleasant but not essential',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=800',
    similarTo: 'Macau — where Asian and European cultures blend uniquely',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=800',
    similarTo: 'Costa Rica — volcanic landscapes and incredible nature',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1553653924-39b70295f8da?w=800',
    similarTo: 'Budapest, Hungary — famous thermal baths and spa culture',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Byron Bay, Australia — beautiful coast but off the beaten path',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800',
    similarTo: 'Reykjavik, Iceland — volcanoes everywhere but hard to reach',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=800',
    similarTo: 'Hawaii — tropical beaches, unique culture, and island hopping',
  },
];
