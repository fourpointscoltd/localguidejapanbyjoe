...
1. **Go during off-peak hours** - Avoid 12:00-13:00 lunch rush
2. **Lines move fast** - Even a long line usually means 15-20 minutes
3. **Use the ticket machine** - Order and pay at the machine before sitting
4. **Don't be shy about slurping** - It's expected and polite in Japan
...
1. **Rokurinsha is worth the wait** - But only if you like tsukemen

2. **Try something you can't get at home** - Don't just go for basic tonkotsu

3. **Last order is usually 22:00-22:30** - Check individual shop hours

4. **Ramen Street is in B1F** - Follow signs for "First Avenue Tokyo Station"

5. **You can eat at multiple shops** - Portions are reasonable enough for two rounds
