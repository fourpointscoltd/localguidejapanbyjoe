---
title: "Can I reload and use a Suica card with someone else's name?"
...
Officially, Suica cards are meant to be used only by the person whose name is registered on the card. When you buy a personalized Suica, your name is printed on it, and for things like reissuing a lost card, your ID has to match that name. So from a rules perspective, it’s technically not allowed for someone else to use it.

But here’s the reality: many people casually share or pass around Suica cards among friends or family. I’ve done this myself—if a friend loses theirs or if you run out of charge, you might borrow theirs briefly. No one’s getting arrested over it. The system doesn’t actively police whose name is on the card when you tap in and out.
