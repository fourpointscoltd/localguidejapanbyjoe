...
1. **Clear umbrellas are iconic** - Everyone uses them in Tokyo

2. **Underground Tokyo is huge** - You can walk between stations underground

3. **Rainy season (Tsuyu) is June-July** - But it doesn't rain all day every day

4. **Temples in rain are magical** - Seriously, don't skip them

5. **Convenience stores save the day** - Umbrellas, ponchos, towels - all available
