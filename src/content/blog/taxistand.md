...
1. **No tipping** - Just pay the meter amount

2. **Taxi app "GO"** - Useful for booking when there's no taxi stand nearby

3. **Have your hotel card** - Show the driver your hotel's address in Japanese

4. **Late night** - Taxis get busy after last train (around midnight)

5. **Receipts** - Drivers always offer receipts automatically
